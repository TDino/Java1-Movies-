...
public class Zadatak01 extends javax.swing.JFrame {
    ...
    private static final String UPLOAD_ARTICLES = "Upload Movie";
    private static final String EDIT_ARTICLES = "Add Movie";
    static int ifadmin=0;
    ...
    private void configurePanels() {
        if (ifadmin == 1) {
            ...
            tpContent.add(EDIT_ARTICLES, new EditArticlesPanelAdmin());
        }
        else{
        tpContent.add(UPLOAD_ARTICLES, new UploadArticlesPanel());
